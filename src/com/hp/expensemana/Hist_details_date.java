...
public class Hist_details_date extends Activity{
	ListView lv;
	int n=0;
	SQLiteDatabase db;
	String details[];
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Cursor c=db.rawQuery("select event,amount,mode from expense where date='"+date+"';",null);
		...
		ArrayAdapter<String> ob=new ArrayAdapter<String>(Hist_details_date.this,android.R.layout.simple_list_item_1,details);
		lv.setAdapter(ob);
	}
